          ...
          t.empty(),
            e.forEach(function (e) {
              const n = $("<div>").addClass("card"),
                o = $("<img>").attr("src", e.poster).addClass("card-img-top"),
                s = $("<div>").addClass("card-body"),
                i = $("<h5>").addClass("card-title").text(e.title),
                a = $("<p>")
                  .addClass("card-text")
                  .html(
                    `\n      <strong>Año:</strong> ${
                      ...
                      e.duration
                    }<br>\n      <strong>Género:</strong> ${e.genre.join(
                      ", "
                    )}<br>\n      <strong>Rate:</strong> ${e.rate}<br>\n    `
                  ),
                c = r(e.rate);
              s.append(i, a, c), n.append(o, s), t.append(n);
            });
        };
      },
      425: (e, t, n) => {
        ...
        const $ = L.toFlatObject(L, {}, null, function (e) {
        ...
        var be = oe.hasStandardBrowserEnv
          ? {
              write(e, t, n, r, o, s) {
                ...
                L.isNumber(n) && i.push("expires=" + new Date(n).toGMTString()),
